...
class Load_APIData:
    def __init__(self, url, dbprovider, dbname, user, password, host='localhost', port=5432):
        ...
        print(self.data.content.decode('utf-8'))
    ...
    def insert_data(self, data):
        try:
            ...
            df.to_sql(name='trips_month_stage', con=engine, if_exists='append', index=False)
            print("---- DONE ----")
...
if __name__ == '__main__':
    my_obj = Load_APIData('https://data.cityofchicago.org/Transportation/Transportation-Network-Providers-Trips-2023-/ukxa-jdd7','postgresql','amandb', 'aman' , 12345)
